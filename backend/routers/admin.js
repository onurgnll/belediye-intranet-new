...
router.get("/get-mudur", adminAuth, getMudurler);
router.post("/create-mudur", adminAuth, createMudur);
router.put("/update-mudur/:id", adminAuth, updateMudur);
router.delete("/delete-mudur/:id", adminAuth, deleteMudur);
